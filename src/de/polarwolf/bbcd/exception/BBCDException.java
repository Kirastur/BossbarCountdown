package de.polarwolf.bbcd.exception;

import de.polarwolf.bbcd.commands.Message;

public class BBCDException extends Exception {
	...
	public BBCDException(String contextName, String errorName, String errorDetailText) {
	...
	public BBCDException(String contextName, String errorName, String errorDetailText, Throwable cause) {
	...
	public BBCDException(Message message) {
