...
public class BBCDBossBar {
	...
	protected BossBar createBossbar(Plugin plugin) {
		...
		BossBar myBossBar = plugin.getServer().createBossBar(bbcdTemplate.getTitle(), bbcdTemplate.getColor(), bbcdTemplate.getStyle(), myEmptyFlagArray);
	...
	protected void handleEndGoal() throws BBCDException{
		...
		try {
			...
			BBCDGoalReachedEvent myEvent = new BBCDGoalReachedEvent(this);
